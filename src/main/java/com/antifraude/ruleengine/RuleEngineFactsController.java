    ...
    public ResponseEntity<List<FactDefinition>> listarFacts() {
        return ResponseEntity.ok(List.of(
                ...
                new FactDefinition("tipoLista", "Tipo de lista coincidente", "CATALOGO", "fuente_datos_riesgo",
                        List.of("==", "!=", "in")),
                new FactDefinition("enListaNegra", "Coincide con lista negra propia", "BOOLEANO", null,
                        List.of("exists", "==")),
                new FactDefinition("enListaBlanca", "Coincide con lista blanca propia", "BOOLEANO", null,
                        List.of("exists", "==")),
