...
public class SaasSeedRunner implements CommandLineRunner {
    ...
    private void seedRoles() {
        List<String> permisos = List.of("EMPRESAS_VER", "EMPRESAS_EDITAR", "LICENCIAS_VER", "LICENCIAS_GESTIONAR",
                ...
                "CATALOGOS_EDITAR", "ALERTAS_VER", "ALERTAS_ASIGNAR", "ALERTAS_RESOLVER", "ALERTAS_APROBAR",
        ...
        grant("GERENTE_SUPERVISOR", List.of("REGLAS_VER", "REGLAS_CREAR", "REGLAS_EDITAR", "REGLAS_ACTIVAR", "CATALOGOS_VER", "CATALOGOS_EDITAR", "ALERTAS_VER", "ALERTAS_ASIGNAR", "ALERTAS_RESOLVER", "ALERTAS_APROBAR", "CASOS_VER", "CASOS_GESTIONAR", "CASOS_APROBAR", "REPORTES_VER", "REPORTES_GENERAR"));
