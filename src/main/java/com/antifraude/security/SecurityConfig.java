    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/api/terminos-condiciones/publico").permitAll()
                    .requestMatchers("/api/terminos-condiciones/**").authenticated()
                    ...
                    .requestMatchers(HttpMethod.PATCH, "/api/admin-empresa/**").hasAuthority("LICENCIAS_GESTIONAR")
                    ...
                    .requestMatchers(HttpMethod.PUT, "/api/listas-control/**").hasAuthority("CATALOGOS_EDITAR")
                    .requestMatchers(HttpMethod.DELETE, "/api/listas-control/**").hasAuthority("CATALOGOS_EDITAR")
                    .requestMatchers("/api/listas-control/**").hasAuthority("CATALOGOS_VER")
