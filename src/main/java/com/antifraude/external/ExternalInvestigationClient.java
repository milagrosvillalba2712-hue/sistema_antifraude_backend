...
public class ExternalInvestigationClient {
    ...
    @CircuitBreaker(name = "identificaciones") @Bulkhead(name = "identificaciones")
    ...
    @SuppressWarnings("unchecked")
    @CircuitBreaker(name = "sanciones") @Bulkhead(name = "sanciones")
    public ProviderResult<Map<String, Object>> consultarScreening(String documentoSeguro) {
        return (ProviderResult<Map<String, Object>>) (ProviderResult<?>) http.get(screeningClient, "SCREENING_LISTAS",
